            ...
            Object.assign(l.default.prototype, {
                ...
                enterFullScreen: function () {
                    ...
                    if (!1 === e.options.useFakeFullscreen && d.IS_IOS && d.HAS_IOS_FULLSCREEN && "function" == typeof e.media.originalNode.webkitEnterFullscreen && e.media.originalNode.canPlayType((0,
                        ...
                        if ((0,
                            ...
                            (0,
                                c.addClass)(e.container, e.options.classPrefix + "container-fullscreen"),
                            e.normalHeight = parseFloat(n.height),
                            e.normalWidth = parseFloat(n.width),
                            "native-native" !== e.fullscreenMode && "plugin-native" !== e.fullscreenMode || (d.requestFullScreen(e.container),
                            ...
                            for (var o = e.container.querySelectorAll("embed, object, video"), a = o.length, s = 0; s < a; s++)
                                o[s].style.width = "100%",
                        ...
                        v && (v.style.fontSize = 100 * h + "%",
                            ...
                            e.container.querySelector("." + e.options.classPrefix + "captions-position").style.bottom = "45px");
                        var y = (0,
                            u.createEvent)("enteredfullscreen", e.container);
                ...
                exitFullScreen: function () {
                    ...
                    if (clearTimeout(e.containerSizeTimeout),
                        ...
                        (0,
                            c.removeClass)(e.container, e.options.classPrefix + "container-fullscreen"),
                        e.options.setDimensions) {
                        if (e.container.style.width = e.normalWidth + "px",
                            e.container.style.height = e.normalHeight + "px",
                            t)
                            e.node.style.width = e.normalWidth + "px",
                                e.node.style.height = e.normalHeight + "px";
                        else
                            for (var n = e.container.querySelectorAll("embed, object, video"), o = n.length, i = 0; i < o; i++)
                    ...
                    f && (f.style.fontSize = "",
                        f.style.lineHeight = "",
                        e.container.querySelector("." + e.options.classPrefix + "captions-position").style.bottom = "");
                    var p = (0,
                        u.createEvent)("exitedfullscreen", e.container);
                            ...
                            action: function (e) {
                                if (!isNaN(e.duration) && e.duration > 0) {
                                    e.isVideo && (e.showControls(),
                                        ...
                                        e.container.querySelector("." + r.config.classPrefix + "time-total").focus();
                    ...
                    var y = function (t) {
                            ...
                            if (h < o.left ? h = o.left : h > i + o.left && (h = i + o.left),
                                ...
                                if (p.timefloat) {
                                    ...
                                    f = h - b.left < p.timefloat.offsetWidth ? g : h - b.left >= p.container.offsetWidth - g ? p.total.offsetWidth - g : m,
                                        (0,
                                            u.hasClass)(p.container, p.options.classPrefix + "long-video") && (f += parseFloat(E.marginLeft) / 2 + p.timefloat.offsetWidth / 2),
                                        p.timefloat.style.left = f + "px",
                                        p.timefloatcurrent.innerHTML = (0,
                                            d.secondsToTimeCode)(p.newTime, e.options.alwaysShowHours, e.options.showTimecodeFrameCount, e.options.framesPerSecond, e.options.secondsDecimalLength),
                                        p.timefloat.style.display = "block"
                                }
                            }
                        } else
                            l.IS_IOS || l.IS_ANDROID || !p.timefloat || (f = p.timefloat.offsetWidth + i >= p.container.offsetWidth ? p.timefloat.offsetWidth / 2 : 0,
                                p.timefloat.style.left = f + "px",
                                p.timefloat.style.left = f + "px",
                                p.timefloat.style.display = "block")
                    }
                        , g = function () {
                            var t = p.getCurrentTime()
                                ...
                                , i = (0,
                                    d.secondsToTimeCode)(t, e.options.alwaysShowHours, e.options.showTimecodeFrameCount, e.options.framesPerSecond, e.options.secondsDecimalLength)
                                , r = p.getDuration();
        ...
        Object.assign(r.config, {
            ...
            Object.assign(a.default.prototype, {
                buildcurrent: function (e, t, n, o) {
                    ...
                    a.className = r.options.classPrefix + "time",
                        ...
                        a.innerHTML = '<span class="' + r.options.classPrefix + 'currenttime">' + (0,
                            s.secondsToTimeCode)(0, e.options.alwaysShowHours, e.options.showTimecodeFrameCount, e.options.framesPerSecond, e.options.secondsDecimalLength) + "</span>",
                ...
                buildduration: function (e, t, n, o) {
                    ...
                    if (t.lastChild.querySelector("." + r.options.classPrefix + "currenttime"))
                        t.querySelector("." + r.options.classPrefix + "time").innerHTML += r.options.timeAndDurationSeparator + '<span class="' + r.options.classPrefix + 'duration">' + (0,
                            s.secondsToTimeCode)(r.options.duration, r.options.alwaysShowHours, r.options.showTimecodeFrameCount, r.options.framesPerSecond, r.options.secondsDecimalLength) + "</span>";
                    else {
                ...
                updateCurrent: function () {
                    ...
                    isNaN(t) && (t = 0);
                    var n = (0,
                        s.secondsToTimeCode)(t, e.options.alwaysShowHours, e.options.showTimecodeFrameCount, e.options.framesPerSecond, e.options.secondsDecimalLength);
                    n.length > 5 ? (0,
                        l.addClass)(e.container, e.options.classPrefix + "long-video") : (0,
                            l.removeClass)(e.container, e.options.classPrefix + "long-video"),
                        e.controls.querySelector("." + e.options.classPrefix + "currenttime") && (e.controls.querySelector("." + e.options.classPrefix + "currenttime").innerText = n)
                },
                updateDuration: function () {
                    ...
                    n.length > 5 ? (0,
                        l.addClass)(e.container, e.options.classPrefix + "long-video") : (0,
                            l.removeClass)(e.container, e.options.classPrefix + "long-video"),
                        e.controls.querySelector("." + e.options.classPrefix + "duration") && t > 0 && (e.controls.querySelector("." + e.options.classPrefix + "duration").innerHTML = n)
                }
            })
    }
        , {
                    ...
                    if (this.findTracks(),
                        ...
                        e.chaptersButton.addEventListener("keydown", function (e) {
                            ...
                            e.options.alwaysShowControls ? (0,
                                c.addClass)(e.container.querySelector("." + r.options.classPrefix + "captions-position"), r.options.classPrefix + "captions-position-hover") : (e.container.addEventListener("controlsshown", function () {
                                    (0,
                                    ...
                                    e.container.addEventListener("controlshidden", function () {
                                        o.paused || (0,
                                            c.removeClass)(e.container.querySelector("." + r.options.classPrefix + "captions-position"), r.options.classPrefix + "captions-position-hover")
                                    })),
        ...
        var b = function () {
            function e(t, n) {
                ...
                if (o.node = o.media = r,
                    ...
                    if (o.isDynamic = "audio" !== c && "video" !== c && "iframe" !== c,
                        o.isVideo = o.isDynamic ? o.options.isVideo : "audio" !== c && o.options.isVideo,
                        o.mediaFiles = null,
                        o.trackFiles = null,
                        p.IS_IPAD && o.options.iPadUseNativeControls || p.IS_IPHONE && o.options.iPhoneUseNativeControls)
                        o.node.setAttribute("controls", !0),
                            p.IS_IPAD && o.node.getAttribute("autoplay") && o.play();
                    else if (!o.isVideo && (o.isVideo || !o.options.features.length && !o.options.useDefaultControls) || p.IS_ANDROID && o.options.AndroidUseNativeControls)
                        o.isVideo || o.options.features.length || o.options.useDefaultControls || (o.node.style.display = "none");
                    else {
                        ...
                        if (E.className = o.options.classPrefix + "offscreen",
                            E.innerText = b,
                            ...
                            o.container.addEventListener("focus", function (e) {
                                if (!o.controlsAreVisible && !o.hasFocus && o.controlsEnabled) {
                                    o.showControls(!0);
                                    var t = (0,
                                        m.isNodeAfter)(e.relatedTarget, o.container) ? "." + o.options.classPrefix + "controls ." + o.options.classPrefix + "button:last-child > button" : "." + o.options.classPrefix + "playpause-button > button";
                                    o.container.querySelector(t).focus()
                                }
                            }),
                            o.node.parentNode.insertBefore(o.container, o.node),
                            o.options.features.length || o.options.useDefaultControls || (o.container.style.background = "transparent",
                        ...
                        if (p.IS_ANDROID && y.addClass(o.container, o.options.classPrefix + "android"),
                            ...
                            y.addClass(o.container, o.isVideo ? o.options.classPrefix + "video" : o.options.classPrefix + "audio"),
                        ...
                        o.container.querySelector("." + o.options.classPrefix + "mediaelement").appendChild(o.node),
                            o.media.player = o,
                            o.controls = o.container.querySelector("." + o.options.classPrefix + "controls"),
                    ...
                    if (d.default.MepDefaults = s,
                        new u.default(o.media, s, o.mediaFiles),
                        void 0 !== o.container && o.options.features.length && o.controlsAreVisible && !o.options.hideVideoControlsOnLoad) {
                        var L = (0,
                            m.createEvent)("controlsshown", o.container);
            ...
            return a(e, [{
                        ...
                        if (e)
                            !function () {
                                y.fadeIn(t.controls, 200, function () {
                                    ...
                                    var e = (0,
                                        m.createEvent)("controlsshown", t.container);
                            ...
                            for (var n = t.container.querySelectorAll("." + t.options.classPrefix + "control"), o = 0, i = n.length; o < i; o++)
                        ...
                        if (e)
                            !function () {
                                y.fadeOut(n.controls, 200, function () {
                                    ...
                                    var e = (0,
                                        m.createEvent)("controlshidden", n.container);
                            ...
                            for (var o = n.container.querySelectorAll("." + n.options.classPrefix + "control"), i = 0, r = o.length; i < r; i++)
                ...
                value: function (e, t) {
                    ...
                    if (n.controls && n.enableControls(),
                        n.container && n.container.querySelector("." + n.options.classPrefix + "overlay-play") && (n.container.querySelector("." + n.options.classPrefix + "overlay-play").style.display = ""),
                        !n.created) {
                        if (n.created = !0,
                            n.media = e,
                            n.domNode = t,
                            ...
                            var v = (0,
                                m.createEvent)("controlsready", n.container);
                            ...
                            n.media.addEventListener("timeupdate", function () {
                                isNaN(n.getDuration()) || g === n.getDuration() || (g = n.getDuration(),
                                    (0,
                                        h.calculateTimeFormat)(g, n.options, n.options.framesPerSecond || 25),
                                    n.updateDuration && n.updateDuration(),
                                    n.updateCurrent && n.updateCurrent(),
                                    n.setControlsSize())
                            }),
                ...
                value: function (e, t, n) {
                    ...
                    i && (i.style.display = "none"),
                        ...
                        o.container.querySelector("." + o.options.classPrefix + "cannotplay") && o.container.querySelector("." + o.options.classPrefix + "cannotplay").remove();
                ...
                value: function () {
                    ...
                    if (d = e.isVideo ? "100%" === e.height ? parseFloat(u * i / o, 10) : e.height >= e.width ? parseFloat(u / r, 10) : parseFloat(u * r, 10) : i,
                        isNaN(d) && (d = a),
                        e.container.parentNode.length > 0 && "body" === e.container.parentNode.tagName.toLowerCase() && (u = s.default.innerWidth || l.default.documentElement.clientWidth || l.default.body.clientWidth,
                ...
                value: function () {
                    var e = this
                        ...
                        , n = !1;
                    try {
                        s.default.self !== s.default.top ? (n = !0,
                            t = s.default.frameElement) : t = e.outerContainer
                    } catch (n) {
                        t = e.outerContainer
                    }
                    ...
                    a && (a.style.display = "");
                    for (var l = e.container.querySelectorAll("object, embed, iframe, video"), d = e.height, u = e.width, c = i, f = d * i / u, p = u * r / d, m = r, h = p > i == !1, v = h ? Math.floor(c) : Math.floor(p), y = h ? Math.floor(f) : Math.floor(m), g = h ? i + "px" : v + "px", b = h ? y + "px" : r + "px", E = 0, S = l.length; E < S; E++)
                        l[E].style.height = b,
                            l[E].style.width = g,
                ...
                value: function () {
                    ...
                    if (y.visible(e.container))
                        if (e.rail && y.visible(e.rail)) {
                            ...
                            var d = (0,
                                m.createEvent)("controlsresize", e.container);
                ...
                value: function () {
                    ...
                    a ? -1 === a.indexOf("%") && (a += "px") : a = "auto",
                        ...
                        e.setPlayerSize(0, 0),
                        e.isDynamic ? e.container.parentNode.insertBefore(e.node, e.container) : function () {
                        ...
                        "object" === r(e.container) && (e.container.parentNode.querySelector("." + e.options.classPrefix + "offscreen").remove(),
                            e.container.remove()),
            ...
            , u = {
                ...
                create: function (e, t, n) {
                    ...
                    d.addEventListener("error", function (t) {
                        4 === t.target.error.code && i && (v < y ? (d.src = n[v++].src,
                            d.load(),
        ...
        var i = o(e(3))
            ...
            , f = {
                ...
                create: function (e, t, n) {
                    ...
                    return x && (C.playerVars.playsinline = 1),
